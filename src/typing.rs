...
/// Newtype wrapper for type identifiers.
/// 
/// This design allows for easy changes to the underlying representation
/// without affecting the rest of the codebase. Currently wraps `usize` for
/// efficient indexing into the type arena.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub struct TypeId(usize);

impl TypeId {
    /// Creates a new TypeId from a usize value.
...
/// Variable identifier type alias.
/// 
/// Currently aliased to `Identifier` (String). When varId is fully implemented,
/// this can be changed to use a more efficient representation while maintaining
/// compatibility with the rest of the type system.
pub type VarId = Identifier;
