...
fn test_basic_functionality() {
    ...
    runner.run_statements("let a = 15;").unwrap();
...
fn test_scope() {
    let mut runner = CodeRunner::default();
    runner.run_statements("let y=0;").unwrap();
    runner.run_statements("let x=0;").unwrap();
...
fn test_type_check(){
    let mut runner = CodeRunner::default();
    runner.run_statements("let vec2={x=i64,y=i64};").unwrap();
    runner.run_statements("let y={x=50,y=50};").unwrap();
    runner.run_statements("let y:{x=i64,y=i64}={x=50,y=50};").unwrap();
    let output=runner.run_statements("let y:{x=i64,y=bool}={x=50,y=50};");
